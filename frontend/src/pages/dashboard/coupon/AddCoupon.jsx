...
import { useCreateCouponMutation } from "../../../app/features/coupon/couponApi";
...
const AddCoupon = () => {
  ...
  // Books
  const { data: bookData, isLoading: booksLoading } = useFetchAllBooksQuery();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (data.discountType === "percentage") {
        formData.maxDiscountAmount = Number(data.maxDiscountAmount);
      }

      const createPromise = createCoupon(formData).unwrap();
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <div className="bg-white border-b border-gray-200 shadow-md px-4 rounded-xl py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors font-medium cursor-pointer"
            >
              Reset
            </button>
            <button
              ...
              disabled={isLoading}
              className="px-6 py-2 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 cursor-pointer"
            >
        ...
        <div className="max-w-6xl mx-auto">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Right Column - Settings & Actions (same as before) */}
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="space-y-3">
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="w-full px-4 py-3 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 cursor-pointer"
                    >
                      <FiSave className="w-5 h-5" />
                      <span>
                    ...
                    <button
                      ...
                      className="w-full px-4 py-3 border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg font-medium transition-colors cursor-pointer"
                    >
                      Reset Form
                    </button>
